...
# DEFAULT_CKPT_PATH = './ckpt/Qwen2.5-VL-3B-Instruct'

DEFAULT_CKPT_PATH = './ckpt/Qwen2-VL-2B-Instruct'
...
def _launch_demo(args, model, processor):
    ...
    def call_local_model(model, processor, messages):
        ...
        gen_kwargs = {'do_sample':False, 'max_new_tokens': 512, 'streamer': streamer, **inputs}
